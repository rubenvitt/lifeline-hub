...
1. **Führungsstelle am Benutzer oder Einsatz** (Backend-Feld + Codegen), damit der `an`-Chip
   beim ersten Eintrag vorbelegt werden kann.
2. **„Nächste Lagebesprechung"** als Termin-Quelle, dann als fünfter Schnellwahl-Chip.
3. **Router-Blocker** — verlangt die Umstellung auf `createBrowserRouter`; app-weit.
