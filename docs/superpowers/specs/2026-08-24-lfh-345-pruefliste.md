...
| 2 · Handschuh-Modus | **erfüllt für den Umfang** | Die Dichtestufe greift über den `ConfigProvider`; die Modulzeile ist die einzige Fläche der Gruppe, die ihre Höhe selbst tragen musste, und tut es über zwei Dichtestufen (e2e). Offen bleibt wie überall die Ableitung der Stufe aus dem Einsatzkontext → **LFH-724** |
...
| **LFH-724** (bis 25.09.2026 LFH-373) | Dichtestufe aus dem Einsatzkontext ableiten (Prüflisten-Zeile 2), app-weit |
