...
| 3   | Rückmeldung vor der Serverantwort     | **erfüllt**         | Hingenommener Rest wie in der ETB-Tabelle (Zeile 3). Unverändert gegenüber dem Bestand, bis auf das Warten auf Organisation und Logo. Der Druckzeitpunkt im Kopf ist der des Drucks, auch über den Knopf ohne Logo (`useDrucken.test.tsx`). |
