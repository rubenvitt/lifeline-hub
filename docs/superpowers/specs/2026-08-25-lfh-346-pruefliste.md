...
| **2 · Handschuh-Modus** | **teilweise erfüllt** | Wie Tabelle 1: 72 px sind an dieser Fläche nicht gemessen. Der Zuschnitt ist hier günstiger — bei 72-px-Zeilen wächst ein `layout="vertical"`-Formular in die **Höhe**, und die Höhe hat die Seite (`Col xs={24} lg={12}`, `:182 ff.`), sie hat schon 488 px Bildlaufreserve bei 420 px Sichtfeld. **Kein eigenes Ticket für die fehlende Messung:** wie in Tabelle 1 ist sie ein dritter Eintrag in `STAFFEL`, kein Umbau. Die Stufen**wahl** aus dem Kontext bleibt app-weit offen → **LFH-724** |
...
| **LFH-724** (bis 25.09.2026 LFH-373) | app-weit | Dichtestufe aus dem Einsatzkontext ableiten (Zeile 2 aller drei Tabellen) | aus C10 übernommen |
