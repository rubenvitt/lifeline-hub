...
| --- | --- | --- |
| 2, 12, 13 | Layout-Nachweise, die jsdom nicht führen kann (Zeilenhöhe im Handschuh, Chip-Leiste bei ~390 px, Fokus hinter dem angepinnten Kopf) | **ein e2e-Nachweis für die ETB-Seite**, siehe unten |
| 8 | kein Helligkeitsregler in der Anwendung | eigener Folge-Task aus A0 |
| 12, 3 | Sammelbanner statt eingeschobener Live-Einträge; optimistische Updates | **B6 (LFH-334)** |
| 14 | Spaltenschalter mit Zähler fehlt (`KatalogTabelle` statt `Datensicht`) | eigener Task, Bestand |
| 2 | Dichtestufe wird nicht aus dem Einsatzkontext abgeleitet | B5-Restpunkt |
| 5 | vier hartkodierte Farbwerte im angepinnten Erfassungskopf | mit dem nächsten Zugriff auf `.etb-erfassung-sticky` |
