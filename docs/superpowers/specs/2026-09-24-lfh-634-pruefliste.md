...
**Befunde** (Entscheidung beim Controller, der Produktivcode ist hier nicht geändert):
...
- **S1 — Sammelbanner bei 390 px (`komfortabel`) unlesbar.** Die Segmentleiste
  ...
  Text vollständig da. Gate 1 sieht das nicht, weil dort kein Banner steht.
...
- **S3 — Gefüllter roter Knopf am Tag unter 7 : 1.** Weiß auf `alarm` (#b02318) misst im
  ...
  Tickets erfasst. Nachts liegt der Wert bei 7,18.
...
wegen app-weiter Rollen offen (LFH-643/661/693). Bei Kriterium 12 fehlt für Befund S1 noch ein
Zielticket.
