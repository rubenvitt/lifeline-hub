...
| L‑3 | **Gefahren- & Absperrzonen** | Freies Zeichnen von Flächen/Linien, entitätsloser Annotations-Layer (neue `lage_zone`-Entity, Typ-Katalog, ETB-Spur) | L‑1 | 📝 Design abgestimmt → Plan als Nächstes |
