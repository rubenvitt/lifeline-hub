...
| 12 | Kein Sprung unter dem Cursor | **offen → LFH-691** | Die Belegung der Plätze erfüllt das Kriterium: Die sechs Plätze stehen vor dem Einsatz-Abruf (Bestand LFH-640), ein Wechsel des Zuschnitts geht nur über das Banner (`LageDashboardPage.test.tsx`, „fremde Anordnung … gehalten“), eine Standmeldung ändert den Platz nicht. **Nicht erfüllt ist die Höhe:** In der Klickprobe bei 1440 px bricht die Notiz „von ≈ 1 850 geplant · 1 ohne Meldung“ um. Das Band wird eine Zeile höher, die Paneele rutschen nach unten, und nach der ersten Meldung springt alles zurück. Das ist ein Verhalten des Bausteins `Kennzahl` (die Pegel-Notiz tut dasselbe) und liegt als eigener Fehler in LFH-691. |
...
**Klickprobe (tasks.md 4.2)**, Playwright gegen Backend und Vite dieses Stands, 1440 × 900,
Navigation in der SPA:
1. Einsatz ohne Bezirk: Platz 3 zeigt „Schäden offen“.
2. Bezirk angelegt (Plangröße 1 850, geschätzt), Rückweg zum Dashboard: Platz 3 zeigt
   „Evakuiert“ mit „—“ und „von ≈ 1 850 geplant · 1 ohne Meldung“, **ohne Banner**.
3. Stand 1 320 gemeldet: „≈ 1 320“ mit „von 1 850 geplant“, der Platz bleibt.
4. Räumung aufgehoben: zurück zu „Schäden offen“, ohne Banner.
