...
- [x] 6.7 Vor dem Merge: `git fetch`, `scripts/check-migrationen.sh` (ggf. `--umnummerieren`), dann `./scripts/check-all.sh` grün. Verifiziert durch das Log des Laufs.
