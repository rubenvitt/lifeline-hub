...
| 7 | Eine Farbe = eine Bedeutung | erfüllt (nach Review) | Rollen aus dem Vertrag (`luftqualitaetIndex`, 18. Karte nach `odlStufe`), kein Blau (`bedien`). Die Ebenenfarbe wirkt am Panel-Punkt; sie war zuerst ein Olivgrün (`#5b8c00`) und damit ein zweites „gut“ — jetzt entsättigtes `#5b6b82`, keine Rollenfarbe. Der Inspector-Akzent trägt die Rollenfarbe der Station statt der Ebenenfarbe (`FachebenenInspector.test.tsx`), eine „sehr schlecht“-Station öffnet also keine Karte mit neutralem oder grünem Akzent. |
