...
- [x] 1.1 Migration `0104_auftrag_quell_etb_index.sql` (partieller Index auf `auftrag(quell_etb_eintrag_id)`) anlegen; Nummer gegen `origin/alpha` geprüft; `cargo test` läuft mit ihr durch
