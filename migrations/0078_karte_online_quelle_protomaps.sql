-- no-transaction
-- LFH-192: Protomaps als neuen Online-Quellentyp zulassen.
-- Erweitert CHECK (typ IN ('vektor', 'raster')) um 'protomaps'.
--
...
CREATE TABLE karte_online_quelle_new (
    ...
    name         TEXT    NOT NULL,
    url          TEXT    NOT NULL,
    typ          TEXT    NOT NULL DEFAULT 'vektor' CHECK (typ IN ('vektor', 'raster', 'protomaps')),
    attribution  TEXT,
