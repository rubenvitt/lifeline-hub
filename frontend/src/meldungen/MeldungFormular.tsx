import { Button, Card, DatePicker, Form, Input, InputNumber, Select, Space, Switch } from 'antd';
    ...
    >
      <Form<MeldungFormWerte> form={form} layout="vertical" initialValues={DEFAULTS} onFinish={absenden}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <Form.Item name="meldeweg" label="Meldeweg" style={{ flex: 1 }}>
          ...
          <Form.Item name="meldungsart" label="Meldungsart" style={{ flex: 1 }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          ...
          <Form.Item name="ereigniszeit" label="Ereigniszeit (≠ Erfassung)" style={{ flex: 1 }}>
