...
const DIN5009: Record<string, string> = {
  a: 'Anton', 'ä': 'Ärger', b: 'Berta', c: 'Cäsar', d: 'Dora', e: 'Emil',
  f: 'Friedrich', g: 'Gustav', h: 'Heinrich', i: 'Ida', j: 'Julius', k: 'Kaufmann',
  l: 'Ludwig', m: 'Martha', n: 'Nordpol', o: 'Otto', 'ö': 'Ökonom', p: 'Paula',
  q: 'Quelle', r: 'Richard', s: 'Samuel', 'ß': 'Eszett', t: 'Theodor', u: 'Ulrich',
  'ü': 'Übermut', v: 'Viktor', w: 'Wilhelm', x: 'Xanthippe', y: 'Ypsilon', z: 'Zacharias',
 ...
 */
export function buchstabiere(text: string, tafel: Buchstabiertafel = 'din5009'): BuchstabierZeichen[] {
