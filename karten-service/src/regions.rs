...
static REGIONS: &[Region] = &[
    ...
    Region { slug:"berlin", geofabrik_area:"berlin", name:"Berlin", region:"DE-BE", gruppe:"Bundesländer", lizenz:ODBL },
    Region { slug:"brandenburg", geofabrik_area:"brandenburg", name:"Brandenburg", region:"DE-BB", gruppe:"Bundesländer", lizenz:ODBL },
    Region { slug:"bremen", geofabrik_area:"bremen", name:"Bremen", region:"DE-HB", gruppe:"Bundesländer", lizenz:ODBL },
    Region { slug:"hamburg", geofabrik_area:"hamburg", name:"Hamburg", region:"DE-HH", gruppe:"Bundesländer", lizenz:ODBL },
    Region { slug:"hessen", geofabrik_area:"hessen", name:"Hessen", region:"DE-HE", gruppe:"Bundesländer", lizenz:ODBL },
    Region { slug:"mecklenburg-vorpommern", geofabrik_area:"mecklenburg-vorpommern", name:"Mecklenburg-Vorpommern", region:"DE-MV", gruppe:"Bundesländer", lizenz:ODBL },
    ...
    Region { slug:"rheinland-pfalz", geofabrik_area:"rheinland-pfalz", name:"Rheinland-Pfalz", region:"DE-RP", gruppe:"Bundesländer", lizenz:ODBL },
    Region { slug:"saarland", geofabrik_area:"saarland", name:"Saarland", region:"DE-SL", gruppe:"Bundesländer", lizenz:ODBL },
    Region { slug:"sachsen", geofabrik_area:"sachsen", name:"Sachsen", region:"DE-SN", gruppe:"Bundesländer", lizenz:ODBL },
    Region { slug:"sachsen-anhalt", geofabrik_area:"sachsen-anhalt", name:"Sachsen-Anhalt", region:"DE-ST", gruppe:"Bundesländer", lizenz:ODBL },
    Region { slug:"schleswig-holstein", geofabrik_area:"schleswig-holstein", name:"Schleswig-Holstein", region:"DE-SH", gruppe:"Bundesländer", lizenz:ODBL },
    Region { slug:"thueringen", geofabrik_area:"thueringen", name:"Thüringen", region:"DE-TH", gruppe:"Bundesländer", lizenz:ODBL },
    ...
    Region { slug:"belgium", geofabrik_area:"belgium", name:"Belgien", region:"BE", gruppe:"Nachbarländer", lizenz:ODBL },
    Region { slug:"czech-republic", geofabrik_area:"czech-republic", name:"Tschechien", region:"CZ", gruppe:"Nachbarländer", lizenz:ODBL },
    Region { slug:"denmark", geofabrik_area:"denmark", name:"Dänemark", region:"DK", gruppe:"Nachbarländer", lizenz:ODBL },
    Region { slug:"france", geofabrik_area:"france", name:"Frankreich", region:"FR", gruppe:"Nachbarländer", lizenz:ODBL },
    Region { slug:"luxembourg", geofabrik_area:"luxembourg", name:"Luxemburg", region:"LU", gruppe:"Nachbarländer", lizenz:ODBL },
    Region { slug:"netherlands", geofabrik_area:"netherlands", name:"Niederlande", region:"NL", gruppe:"Nachbarländer", lizenz:ODBL },
    Region { slug:"poland", geofabrik_area:"poland", name:"Polen", region:"PL", gruppe:"Nachbarländer", lizenz:ODBL },
    ...
    Region { slug:"planet", geofabrik_area:"planet", name:"Ganze Welt (Voll-Detail)", region:"WORLD", gruppe:"Welt", lizenz:ODBL },
];
...
mod tests {
    ...
    fn voller_satz_16_bundeslaender_und_9_nachbarn() {
        ...
        let nb = alle().iter().filter(|r| r.gruppe == "Nachbarländer").count();
        ...
        let mut codes: Vec<_> = alle().iter().filter(|r| r.region.starts_with("DE-")).map(|r| r.region).collect();
        let m = codes.len(); codes.sort(); codes.dedup();
